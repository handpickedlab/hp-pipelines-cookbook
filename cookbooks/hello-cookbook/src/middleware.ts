// Wachtwoord-gate voor dit cookbook (voorbeeld). In plaats van de kale
// browser-basic-auth-popup toont dit een nette eigen loginpagina en onthoudt
// de toegang in een cookie. De provisioning-workflow zet de env var
