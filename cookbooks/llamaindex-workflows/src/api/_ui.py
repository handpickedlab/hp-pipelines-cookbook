...
<title>LlamaIndex Workflows — writer-benchmark</title>
<style>
...
<div class="wrap">
  <header>
    <h1>🦙 LlamaIndex Workflows — writer-benchmark</h1>
...
<script>
  ...
  function renderObs(d) {
    ...
    html += '<p class="obs-note">Diepere traces: LlamaIndex instrumenteert via OpenTelemetry (bv. Arize Phoenix of Langfuse). De in-app tokens/latency hierboven werken zonder extra account.</p>';
    html += "</div>";
    return html;
  }
