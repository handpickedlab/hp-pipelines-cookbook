// Wachtwoord-gate voor je cookbook — kopieer dit bestand naar cookbooks/<slug>/src/middleware.ts.
//
// Vercel Routing Middleware is framework-agnostisch: dit werkt voor Next.js,
// statische sites én Python-projecten, zonder dependencies. In plaats van de
// kale browser-basic-auth-popup toont dit een nette eigen loginpagina en
// onthoudt de toegang in een cookie. De provisioning-workflow zet de env var
// SITE_PASSWORD automatisch op nieuwe projecten; zonder die var (bv. lokaal)
// is de site gewoon open.
