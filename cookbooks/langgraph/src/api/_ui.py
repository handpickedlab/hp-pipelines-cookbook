...
<script>
  ...
  function renderObs(d) {
    ...
    html += '<p class="obs-note">Volledige prompt/response-waterfall per run: zet de <code>LANGSMITH_*</code> env-vars (zie HOSTING.md) — dan logt elke call naar LangSmith.</p>';
    html += "</div>";
    return html;
  }
